...
public class PromptConstants {
    public static final String PROMPT_DELIMITER = " <CoattailLasko4083> ";
    public static final String PROMPT_WHAT_WERE_WE_TALKING_ABOUT = "Here is the turn history (including previous 2 turns) you need to know.";//"We have been talking about these things as of now. ";
